...
CKPT_DIR="/home/leadtek/lambda_share/VLA-Adapter/outputs/configs+libero_10_no_noops+b16+lr-0.0002+lora-r64+dropout-0.0--image_aug--VLA-Adapter--token--long-4GPU--libero_10_no_noops--2025-12-23_10-10-07--30000_chkpt"
if [ -z "${CKPT_DIR}" ]; then
...
RUN_ID_NOTE="${RUN_ID_NOTE:-local-lora-eval-long}"
