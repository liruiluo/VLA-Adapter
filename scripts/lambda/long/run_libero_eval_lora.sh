...
# === LoRA (merged) LIBERO-long eval ===

CKPT_DIR="outputs/configs+libero_10_no_noops+b16+lr-0.0002+lora-r64+dropout-0.0--image_aug--VLA-Adapter--long-4GPU--libero_10_no_noops--2025-12-21_03-58-00--30000_chkpt"
if [ -z "${CKPT_DIR}" ]; then
