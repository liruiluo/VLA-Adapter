...
from .configuration_prismatic import OpenVLAConfig, VLAAdapterConfig, PrismaticConfig
...
class VLAAdapterForActionPrediction(PrismaticForConditionalGeneration):
    """VLA-Adapter model with L1 regression, proprio, multi-image, and action chunking support."""
    config_class: PretrainedConfig = VLAAdapterConfig
